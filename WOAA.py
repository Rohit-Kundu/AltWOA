...
#Altruistic Whale Optimization Algorithm (AWOA)
def AWOA(num_agents, max_iter, train_data, train_label,
    ...
    # format the data 
    data = Data()
    data.train_X, data.val_X, data.train_Y, data.val_Y = train_data, test_data, train_label, test_label #train_test_split(train_data,train_label,test_size=0.2,shuffle=False)
    ...
    scc = generate_scc(train_data,train_label)
    pcc = generate_pcc(train_data,train_label)
