...
def compute_preds(agent, train_X, test_X, train_Y):
...
def compute_fitness(agent, train_X, test_X, train_Y, test_Y, weight_acc=0.7, dims=None):
...
def AltWOA(num_agents, max_iter, train_data, train_label,
    ...
    preds = compute_preds(Leader_agent, data.train_X, data.val_X, data.train_Y)
