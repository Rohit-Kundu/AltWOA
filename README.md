...
AltWOA is a novel feature selection algorithm where `Altruistic` property of candidate whales are embedded to the Whale Optimization Algorithm (WOA) (Refer to our paper published in _Computers in Biology and Medicine, Elsevier_: [Link](https://doi.org/10.1016/j.compbiomed.2022.105349)). 
